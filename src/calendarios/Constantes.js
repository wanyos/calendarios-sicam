...
export const CATEGORIAS = [
    ...
    { value: 'Grua',              text: 'Grua Asistencia' },
    { value: 'GruaDSM',           text: 'Grua DSM' },
    { value: 'GruaDSM_Noche',     text: 'Grua DSM Noche' },
    { value: 'ParkingDSM_100',    text: 'Parking DSM 100%' },
    { value: 'ParkingDSM_50',     text: 'Parking DSM 50%' },
